...
# 96 "../../../../Library/StdDriver/src/clk.c"
void CLK_Idle(void)
{
...
# 141 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetLXTFreq(void)
{
    uint32_t u32Freq = 0UL;
...
# 309 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
...
# 541 "../../../../Library/StdDriver/src/clk.c"
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
...
# 593 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableXtalRC(uint32_t u32ClkMask)
{
...
# 674 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableModuleClock(uint32_t u32ModuleIdx)
{
...
# 766 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    if((u32PllFreq <= 144000000UL) && (u32PllFreq >= 24000000UL))
    {
        ...
        ((CLK_T *) ((0x40000000UL) + 0x00200UL))->PLLCTL = u32PllClkSrc | (u32NO << 14) | ((u32MinNR - 1UL) << 9) | (u32MinNF - 2UL);
...
# 905 "../../../../Library/StdDriver/src/clk.c"
void CLK_DisablePLL(void)
{
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->PLLCTL |= (0x1ul << (16));
}
# 925 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_WaitClockReady(uint32_t u32ClkMask)
{
...
# 955 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableSysTick(uint32_t u32ClkSrc, uint32_t u32Count)
{
...
# 1004 "../../../../Library/StdDriver/src/clk.c"
void CLK_SetPowerDownMode(uint32_t u32PDMode)
{
...
# 1031 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetPMUWKSrc(void)
{
    return (((CLK_T *) ((0x40000000UL) + 0x00200UL))->PMUSTS);
}
# 1050 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableSPDWKPin(uint32_t u32Port, uint32_t u32Pin, uint32_t u32TriggerType, uint32_t u32DebounceEn)
{
...
# 1073 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetPLLClockFreq(void)
{
...
# 1157 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockSource(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL, u32TmpAddr = 0UL;
    uint32_t au32SelTbl[4] = {0x0UL, 0x4UL, 0x8UL, 0xCUL};
...
# 1213 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockDivider(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL, u32TmpAddr = 0UL;
    uint32_t au32DivTbl[4] = {0x0UL, 0x4UL, 0x8UL, 0x10UL};
