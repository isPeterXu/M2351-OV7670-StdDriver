...
# 44 "../../../../Library/StdDriver/src/retarget.c"
FILE __stdout;
FILE __stdin;
...
# 180 "../../../../Library/StdDriver/src/retarget.c"
...
# 232 "../../../../Library/StdDriver/src/retarget.c"
    while(1U|*sp){}
...
void SendChar(int ch)
{
# 364 "../../../../Library/StdDriver/src/retarget.c"
    SendChar_ToUART(ch);

}
# 377 "../../../../Library/StdDriver/src/retarget.c"
char GetChar(void)
{
# 415 "../../../../Library/StdDriver/src/retarget.c"
    while(1)
    {
...
# 467 "../../../../Library/StdDriver/src/retarget.c"
void _ttywrch(int ch)
{
    SendChar(ch);
    return;
}
# 492 "../../../../Library/StdDriver/src/retarget.c"
int fputc(int ch, FILE *stream)
{
    SendChar(ch);
    return ch;
}
# 542 "../../../../Library/StdDriver/src/retarget.c"
int fgetc(FILE *stream)
{
    return ((int)GetChar());
}
# 562 "../../../../Library/StdDriver/src/retarget.c"
int ferror(FILE *stream)
{
    return (-1);
}
