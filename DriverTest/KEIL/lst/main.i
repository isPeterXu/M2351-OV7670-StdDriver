...
char d[] = "e5ce89a34adddf25ff3bf1ffe6803f57d0220de3118798ea";
char Qx[] = "8abf7b3ceb2b02438af19543d3e5b1d573fa9ac60085840f";
char Qy[] = "a87f80182dcd56a6a061f81f7da393e7cffd5e0738c6b245";

char gKey1[168], gKey2[168];


char g_SHA_msg[] = "608079423f12421de616b7493ebe551cf4d65b92";
char *gD = d;
char gK[] = "cb0abc7043a10783684556fb12c4154d57bc31a289685f25";
char gR[] = "6994d962bdd0d793ffddf855ec5bf2f91a9698b46258a63e";
char gS[] = "b5e6ed717dd0557a070b810d097ed35fa2c2495226150ed4";

char gR1[168], gS1[168];
...
{
    ECC_DriverISR(((CRPT_T *) ((0x40000000UL) + 0x32000UL)));
}
...
void SYS_Init(void)
{
    ...
    while((((CLK_T *) ((0x40000000UL) + 0x00200UL))->STATUS & (0x1ul << (2))) == 0);


    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKDIV0 = (((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKDIV0 & (~(0xful << (0)))) | 1;


    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL0 = (((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL0 & (~(0x7ul << (0)))) | (0x02UL<<(0));


    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL1 = (0x3UL<<(24));
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL3 = (0x3UL<<(30));


    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->AHBCLK |= (0x1ul << (12));
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->APBCLK0 |= (0x1ul << (16)) | (0x1ul << (2)) | (0x1ul << (21));
...
void DEBUG_PORT_Init()
{
    ...
    ((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->LINE = (0x0UL << (3)) | (0x0UL << (2)) | (3UL);
...
int32_t main(void)
{
  ...
  printf("+---------------------------------------------+\n");
    ...
    if(ECC_GeneratePublicKey(((CRPT_T *) ((0x40000000UL) + 0x32000UL)), CURVE_P_192, d, gKey1, gKey2) < 0)
    {
  ...
  printf("+---------------------------------------------+\n");
    printf("|   Crypto ECC Signature Generation Demo     |\n");
    printf("+---------------------------------------------+\n");


  if(ECC_GenerateSignature(((CRPT_T *) ((0x40000000UL) + 0x32000UL)), CURVE_P_192, g_SHA_msg, gD, gK, gR1, gS1) < 0)
    {
    ...
    printf("+---------------------------------------------+\n");
    printf("|   Crypto ECC Signature Verification Demo    |\n");
    printf("+---------------------------------------------+\n");


    if(ECC_VerifySignature(((CRPT_T *) ((0x40000000UL) + 0x32000UL)), CURVE_P_192, sha_msg, Qx, Qy, R, S) < 0)
    {
