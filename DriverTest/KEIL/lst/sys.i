...
# 37 "../../../../Library/StdDriver/src/sys.c"
void SYS_ClearResetSrc(uint32_t u32Src)
{
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->RSTSTS = u32Src;
}
# 49 "../../../../Library/StdDriver/src/sys.c"
uint32_t SYS_GetBODStatus(void)
{
...
# 72 "../../../../Library/StdDriver/src/sys.c"
uint32_t SYS_IsRegLocked(void)
{
...
# 95 "../../../../Library/StdDriver/src/sys.c"
void SYS_ResetChip(void)
{
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->IPRST0 |= (0x1ul << (0));
}
# 107 "../../../../Library/StdDriver/src/sys.c"
void SYS_ResetCPU(void)
{
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->IPRST0 |= (0x1ul << (1));
}
# 165 "../../../../Library/StdDriver/src/sys.c"
void SYS_ResetModule(uint32_t u32ModuleIndex)
{
...
# 197 "../../../../Library/StdDriver/src/sys.c"
void SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{
    ...
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->BODCTL = (((SYS_T *) ((0x40000000UL) + 0x00000UL))->BODCTL & ~(0x1ul << (3))) | (uint32_t)i32Mode;


    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->BODCTL = (((SYS_T *) ((0x40000000UL) + 0x00000UL))->BODCTL & ~(0x7ul << (16))) | u32BODLevel;
}
...
# 231 "../../../../Library/StdDriver/src/sys.c"
void SYS_SetPowerLevel(uint32_t u32PowerLevel)
{
...
uint32_t SYS_SetPowerRegulator(uint32_t u32PowerRegulator)
{
    ...
    if((u32PowerRegulator == (0x1UL<<(4))) && (u32PowerRegStatus == (0x0UL<<(12))))
    {
        ...
        while((((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLSTS & (0x1ul << (12))) != (0x1UL<<(12)))
        {
            if(i32TimeOutCnt-- <= 0)
            {
                u32Ret = 0U;
    ...
    else if(u32PowerRegulator == (0x0UL<<(4)))
    {
        ...
        while((((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLSTS & (0x1ul << (12))) != (0x0UL<<(12)))
        {
            if(i32TimeOutCnt-- <= 0)
            {
                u32Ret = 0U;
...
# 323 "../../../../Library/StdDriver/src/sys.c"
void SYS_SetSSRAMPowerMode(uint32_t u32SRAMSel, uint32_t u32PowerMode)
{
    ...
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->SRAMPCTL = (((SYS_T *) ((0x40000000UL) + 0x00000UL))->SRAMPCTL & (~u32SRAMSel)) | (u32PowerMode << u32SRAMSelPos);
}
# 360 "../../../../Library/StdDriver/src/sys.c"
void SYS_SetPSRAMPowerMode(uint32_t u32SRAMSel, uint32_t u32PowerMode)
{
    ...
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->SRAMPPCT = (((SYS_T *) ((0x40000000UL) + 0x00000UL))->SRAMPPCT & (~u32SRAMSel)) | (u32PowerMode << u32SRAMSelPos);
}
