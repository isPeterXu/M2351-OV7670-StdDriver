...
char g_SHA_msg[] = "608079423f12421de616b7493ebe551cf4d65b92";     /* SHA-1 hash (Pattern)                          */
char *gD = d;    																									 /* private key                                   */
...
char gS[] = "b5e6ed717dd0557a070b810d097ed35fa2c2495226150ed4";    /* Expected answer: S of (R,S) digital signature */

char gR1[168], gS1[168];                                           /* temporary buffer used to keep digital signature (R,S) pair */

char sha_msg[] = "608079423f12421de616b7493ebe551cf4d65b92";       /* SHA-1 hash (Pattern)                          */
char *R = gR;    																									 /* Expected answer: R of (R,S) digital signature */
char *S = gS;    																									 /* Expected answer: S of (R,S) digital signature */
